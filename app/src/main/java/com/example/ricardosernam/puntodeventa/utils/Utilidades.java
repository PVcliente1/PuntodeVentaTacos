...
/*public class Utilidades {
    ...
    public static JSONObject deCursorAJSONObject(Cursor c) {
        ...
        //idinventario = c.getString(COLUMNA_ID_REMOTA_INVENTARIO_DETALLE);
        idproducto = c.getString(COLUMNA_ID_PRODUCTO_INVENTARIO_DETALLE);
        existente = c.getDouble(COLUMNA_EXISTENTE);

        try {
            //jObject.put(ContractParaProductos.Columnas.ID_REMOTA, idinventario);
