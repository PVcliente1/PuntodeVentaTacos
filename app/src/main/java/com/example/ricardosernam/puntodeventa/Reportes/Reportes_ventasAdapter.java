...
public class Reportes_ventasAdapter extends RecyclerView.Adapter<Reportes_ventasAdapter.HistorialVentasViewHolder> {
    private ArrayList<Historial_ventas_class> itemsHistorial;
    private Context context;
    private interfaz_OnClick Interfaz;

    public Reportes_ventasAdapter(Context context, ArrayList<Historial_ventas_class> itemsCobrar, interfaz_OnClick Interfaz) {  ///recibe el arrayCobrar como parametro
