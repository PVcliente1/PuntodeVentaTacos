...
public class BaseDeDatosLocal extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE Proveedores(id INTEGER PRIMARY KEY AUTOINCREMENT, Contacto TEXT, Telefono TEXT, Direccion TEXT, Empresa TEXT)");
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        sqLiteDatabase.execSQL("DROP TABLE Proveedores");
        sqLiteDatabase.execSQL("CREATE TABLE Proveedores(id INTEGER PRIMARY KEY AUTOINCREMENT, Contacto TEXT, Telefono TEXT, Direccion TEXT, Empresa TEXT)");
        sqLiteDatabase.execSQL("CREATE TABLE Usuarios(id INTEGER PRIMARY KEY AUTOINCREMENT, Nombre TEXT, Contrasena TEXT)");
    }
}
