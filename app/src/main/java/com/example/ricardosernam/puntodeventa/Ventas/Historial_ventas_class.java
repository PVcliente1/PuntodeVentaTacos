...
public class Historial_ventas_class {
    ...
    public Historial_ventas_class(String tipo_venta, String fecha, String fecha_entrega, String descripcion, String tipo_cobro) {   ///se manda desde el arrayProductos
